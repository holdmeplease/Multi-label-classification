...
model_path = './model_pth/vgg_16.pth'#dir to save para
BATCH_SIZE = 100
LR = 0.01
EPOCH = 5
...
trainData = myDataSet(root='../data/train', label=train_label,transform=transform)
testData = dsets.ImageFolder(root='../data/test', label=test_label,transform=transform)
...
torch.save(nn.state_dict(), 'vgg_16.pkl')
